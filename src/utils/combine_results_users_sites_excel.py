...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Combine CSV results into Excel file')
    parser.add_argument('results_path', help='Path to directory containing CSV files')
